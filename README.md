...
git clone https://github.com/shadog/shado.alasmr.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf shado.alasmr && rm -rf .telegram-cli && git clone https://github.com/shadog/shado.alasmr.git && cd shado.alasmr && ./launch.sh install && ./launch.sh
~~~~~
